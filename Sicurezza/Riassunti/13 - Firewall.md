...
Il firewall ha quindi due schede di rete, una collegata al router e l'atrtra alla rete interna.
...
Rappresenta quindi un ilteriore livello di sicurezza: un host appartenente ad una rete esterna puó accedere solo ai servizi messi a disposizione, senza quindi mettere a rischio l'intera rete.
#### Screened Subnet
...
#### Packet filter
É un router che lavora a livello rete ma anche trasporto.
...
##### Il problema di FTP
FTP é un protocollo a livello applicativo, che é uno demi motivi per cui vengono usati altri firewall oltre ai packet filter.
...
- altrimenti permettiamo l'avvio do una connessione a chiunque sulla porta 20 del client
...
I **firewall applicativi** lavorano a livello applicativo e quindi sono in grado di **leggere** tutto il **pacchetto** e di trarne informazioni utili allo scopo del firewall. 
